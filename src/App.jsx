    ...
    <div className="app-container">
      ...
      <div className="counter-card">
        <div className="header">
          <span className="header-icon floating">🍽️</span>
        ...
        {meals.length > 0 ? (
          ...
          <div className="empty-state">
            <div className="empty-emoji bounce">🍽️</div>
          ...
          <div className="calories-summary">
            <span>
              {totalCalories <= dailyGoal ? (
                <>
                  {Math.round((dailyGoal - totalCalories) * 10) / 10} kcal remaining ⬇️
                </>
              ) : (
                <>
                  {Math.round((totalCalories - dailyGoal) * 10) / 10} kcal over limit ⬆️
                </>
              )}
            </span>
          </div>
